...
// Class: EffectGameObject_base @ 0x4a5f30
// (Geode 2.2081 bindings)


void FUN_1404a5f30(longlong *param_1,longlong *param_2,int param_3,longlong param_4)
  ...
  if ((int)param_1[0x74] == 0x1e) {
    if ((char)param_1[0xd5] != '\0') {
      ...
      if (*(char *)((longlong)param_1 + 0x6a7) == '\0') {
        ...
        local_res8 = (undefined1 *)CONCAT44(local_res8._4_4_,iVar34);
        plVar15 = (longlong *)FUN_140060b20(lVar17 + 0x330,&local_108,&local_res8);
      ...
      FUN_1402624b0(lVar17,(ulonglong)local_res8 & 0xffffffff,iVar34);
    ...
    if (*(char *)((longlong)param_1 + 0x6a9) != '\0') {
      ...
      if (bVar39) {
        ...
        ppuVar16 = (undefined1 **)FUN_14024b270(&local_d8,param_4);
      }
      (**(code **)param_2[0x33])
      ...
      if ((bVar39) && (local_108 != (undefined1 *)0x0)) {
        puVar27 = local_108;
        if ((0xfff < (ulonglong)((local_f8 - (longlong)local_108 >> 2) * 4)) &&
           (puVar27 = *(undefined1 **)(local_108 + -8),
           (undefined1 *)0x1f < local_108 + (-8 - (longlong)puVar27))) {
    ...
    if (0xb53 < iVar34) {
      if (0xe12 < iVar34) {
        ...
        case 0xe18:
          ...
          cocos2d::CCPoint::CCPoint((CCPoint *)&local_res8,pCVar26);
          if ((0 < *(int *)((longlong)param_1 + 0x5cc)) &&
            ...
            cocos2d::CCPoint::operator=((CCPoint *)&local_res8,pCVar26);
          ...
          iVar14 = rand();
          local_res8 = (undefined1 *)
                       CONCAT44(local_res8._4_4_ +
                                (((float)iVar14 / fVar11 + (float)iVar14 / fVar11) - fVar10) *
                                *(float *)((longlong)param_1 + 0x74c) +
                                *(float *)((longlong)param_1 + 0x744),(float)local_res8);
          lVar17 = param_1[0xb9];
          uVar19 = cocos2d::CCPoint::CCPoint((CCPoint *)&local_108,(CCPoint *)&local_res8);
...
LAB_1404a7f5e:
        ...
        case 0xe38:
          ...
          if (bVar39) {
            ...
            ppuVar16 = (undefined1 **)FUN_14024b270(local_90,param_4);
          }
          (**(code **)(param_2[0x33] + 8))
          ...
          if (!bVar39) {
            FUN_14005e430(local_90);
          }
          local_res8 = (undefined1 *)
                       CONCAT44(local_res8._4_4_,*(undefined4 *)((longlong)param_1 + 0x39c));
          plVar15 = (longlong *)FUN_1402505b0(param_2 + 0xa9,&local_108,&local_res8);
      ...
      case 0xbd0:
        ...
        local_108 = (undefined1 *)CONCAT44(local_108._4_4_,iVar34);
        local_res8 = (undefined1 *)((ulonglong)(uint)local_res8._4_4_ << 0x20);
        uVar29 = uVar36;
        do {
          iVar14 = (int)uVar29;
          if (iVar14 == 0) {
...
LAB_1404a78a5:
          ...
          uVar13 = (int)(float)local_res8 + 1;
          uVar29 = (ulonglong)uVar13;
          local_res8 = (undefined1 *)CONCAT44(local_res8._4_4_,uVar13);
          if (4 < (int)uVar13) {
            return;
          }
        } while( true );
      case 0xbd9:
        if (param_4 == 0) {
          ...
          puVar23 = (undefined8 *)FUN_14024b270(local_b8,param_4);
          bVar30 = 0x40;
        }
    ...
    if (0x64c < iVar34) {
      if (0x714 < iVar34) {
        ...
        case 0x717:
          if (*(char *)((longlong)param_1 + 0x6a6) != '\0') {
            ...
            if (bVar39) {
              ...
              ppuVar16 = (undefined1 **)FUN_14024b270(local_b8,param_4);
            }
        ...
        case 0x71a:
          ...
          if (DAT_1406c2ed8 == (longlong *)0x0) {
            local_res8 = (undefined1 *)FUN_1404d0770(0x668);
      ...
      if (iVar34 == 0x714) {
        ...
        lVar17 = param_1[0xd3];
        local_108 = (undefined1 *)CONCAT44(local_108._4_4_,(int)lVar17);
        uVar42 = *(undefined4 *)((longlong)param_1 + 0x39c);
        local_110[0] = *(CCPoint *)((longlong)param_1 + 0x675);
        local_res8 = (undefined1 *)CONCAT71(local_res8._1_7_,local_110[0]);
        lVar18 = param_1[0xb9];
        local_c0 = (longlong *)CONCAT44(local_c0._4_4_,(int)lVar18);
        local_e0[0] = uVar42;
        CVar33 = local_110[0];
        if (DAT_1406c2ed8 == (longlong *)0x0) {
          local_98 = FUN_1404d0770(0x668);
          DAT_1406c2ed8 = (longlong *)FUN_14017ab00(local_98);
          (**(code **)(*DAT_1406c2ed8 + 0x48))(DAT_1406c2ed8);
          CVar33 = local_res8._0_1_;
        }
        lVar31 = *(longlong *)(DAT_1406c2ed8[0x41] + 0x950);
        puVar27 = *(undefined1 **)(lVar31 + 0x268);
        if (puVar27 == *(undefined1 **)(lVar31 + 0x270)) {
          FUN_14026c550(lVar31 + 0x260,puVar27,&local_c0,local_110,puVar23,local_e0,&local_108);
        }
        else {
          *puVar27 = 0;
    ...
    if (iVar34 < 0x532) {
      if (iVar34 != 0x531) {
        ...
        default:
          return;
        case 0x3ee:
          local_108 = *(undefined1 **)((longlong)param_1 + 0x65c);
          uStack_100 = *(undefined8 *)((longlong)param_1 + 0x664);
          local_res8 = (undefined1 *)
                       CONCAT53(local_res8._3_5_,*(undefined3 *)((longlong)param_1 + 0x5b9));
          FUN_140260c40(param_2[0x12a],(int)param_1[0xb9],CONCAT31(uVar7,(int)param_1[0xcb] == 1),
                        ...
                        &local_res8,&local_108,*(undefined4 *)((longlong)param_1 + 0x66c),
    ...
    if (0x5f0 < iVar34) {
      ...
      local_a0[0] = (undefined4)param_1[0xd3];
      uVar42 = *(undefined4 *)((longlong)param_1 + 0x39c);
      local_98 = CONCAT44(local_98._4_4_,uVar42);
      local_e8[0] = (undefined1)param_1[0xd0];
      uVar12 = *(undefined4 *)((longlong)param_1 + 0x67c);
      local_c0 = (longlong *)CONCAT44(local_c0._4_4_,uVar12);
      local_e0[0] = (undefined4)param_1[0xcf];
      local_110[0] = *(CCPoint *)((longlong)param_1 + 0x676);
      local_res8 = (undefined1 *)CONCAT71(local_res8._1_7_,local_110[0]);
      lVar18 = param_1[0xb9];
      local_108 = (undefined1 *)CONCAT44(local_108._4_4_,(int)lVar18);
      lVar17 = param_2[0x12a];
      puVar27 = *(undefined1 **)(lVar17 + 0x1f8);
      if (puVar27 == *(undefined1 **)(lVar17 + 0x200)) {
        FUN_14026c2b0(lVar17 + 0x1f0,puVar27,&local_108,local_110,local_e0,&local_c0,local_e8,
                      puVar23,&local_98,local_a0);
      }
      else {
        *puVar27 = 0;
        *(undefined8 *)(puVar27 + 0x20) = 0;
        ...
        *(int *)(puVar27 + 4) = (int)lVar18;
        *(CCPoint *)(puVar27 + 8) = local_110[0];
        *(undefined4 *)(puVar27 + 0xc) = local_e0[0];
        *(undefined4 *)(puVar27 + 0x10) = uVar12;
        puVar27[0x1c] = local_e8[0];
        *(undefined4 *)(puVar27 + 0x14) = uVar42;
        *(undefined4 *)(puVar27 + 0x18) = local_a0[0];
        local_108 = puVar27;
    ...
    local_res8 = (undefined1 *)FUN_140224590(param_2,(int)param_1[0xb9]);
    if (*(char *)((longlong)param_1 + 0x6a4) == '\0') {
      if (*(char *)((longlong)param_1 + 0x6a5) == '\0') {
...
LAB_1404a67a4:
    ...
    if (((lVar17 != 0) && (lVar18 != 0)) && (local_res8 != (undefined1 *)0x0)) {
      ...
      FUN_14021efb0(param_1,lVar17,local_res8,lVar18,uVar22,uVar21,uVar20,uVar19);
    }
LAB_1404a682b:
...
switchD_1404a6182_caseD_16:
      ...
      if (((int)param_1[0xe8] == 1) || ((int)param_1[0xe8] == 0)) {
        *(int *)(param_2[0xc5] + (longlong)(int)param_1[0x100] * 4) = iVar14;
        if (iVar14 == -0xf) {
          ...
          local_res8 = (undefined1 *)CONCAT44(local_res8._4_4_,*(uint *)(param_1 + 0x100));
          if (*(uint *)(param_1 + 0x100) < 0x65) {
            FUN_14024a470(param_2 + 0xb5,&local_res8);
          }
        }
      }
      if (((int)param_1[0xe8] != 2) && ((int)param_1[0xe8] != 0)) {
      ...
      *(int *)(param_2[200] + (longlong)(int)param_1[0x100] * 4) = iVar14;
      ...
      FUN_14024a470(param_2 + 0xbd,&local_res8);
      return;
    case 0x1d:
    case 0x1e:
    case 0x69:
...
LAB_1404a7c0e:
  ...
  if (*(char *)((longlong)param_1 + 0x716) == '\0') {
    ...
    bVar9 = !bVar41;
    puVar23 = (undefined8 *)FUN_14024b270(local_b8,ppuVar16);
    bVar8 = true;
    bVar39 = false;
  }
  if (cVar40 == '\0') {
...
switchD_1404a73e5_caseD_bc8:
  ...
  *piVar1 = iVar14 + 1;
  ...
  local_c0 = param_1;
  FUN_140251cb0(param_2 + 0xe3,puVar23,&local_c0,param_1 + 0xb9,&local_res8,local_e0,piVar1,
                &local_108);
LAB_1404a7531:
  *(undefined1 *)(param_2 + 0xe2) = 1;
  return;
