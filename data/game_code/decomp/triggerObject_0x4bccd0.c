// triggerObject @ 0x4bccd0
// Function: FUN_1404bccd0


void FUN_1404bccd0(undefined8 param_1,longlong *param_2,undefined8 param_3,longlong param_4)

{
  ...
  (**(code **)(*param_2 + 0x458))(param_2,param_1,ppvVar1);
  if (bVar2) {
