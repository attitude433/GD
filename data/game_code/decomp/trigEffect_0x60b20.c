...
// Function: FUN_140060b20 @ 0x60b20


undefined8 * FUN_140060b20(float *param_1,undefined8 *param_2,byte *param_3)

{
  ...
  puVar6 = (undefined8 *)FUN_1404d0770(0x18);
  ...
  *puVar2 = puVar6;
  ...
  if (puVar4 == *(undefined8 **)(param_1 + 2)) {
    *(undefined8 **)(lVar3 + uVar9 * 0x10) = puVar6;
    ...
    if (*(undefined8 **)(lVar3 + 8 + uVar9 * 0x10) != puVar2) goto LAB_140060d58;
  }
